...
import { programmingSkillsDetails } from "./ProgrammingSkills/programmingSkillsDetails";
import { projectsDetails } from "./Projects/projectDetails";
    ...
    <div className="experience-container">
      ...
      <div className="experience-description">
        <span className="resume-description-text">
          ...
          design specifications for FlipTree app.
        </span>
        <br />
        <span className="resume-description-text">
