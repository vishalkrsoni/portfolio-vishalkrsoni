                ...
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      ...
                      We build a self-sustainable ecosystem for our FMCG
                      Start-Up together. He is a gem of a person. He can figure
                      out the problem areas and execute real-time changes
                      quickly. He has also gained extensive experience with
                      operations management and workflow managament.
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      <i className="fa fa-quote-left" />
                      Working with Vishal was good and we had really high
                      expectations. He is always ready to learn new things by
                      doing all the research about best practices and
                ...
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      ...
                      efficiently in accordance with best practices. The entire
                      management expresses gratitude to him. Along with adding
                      value in the product developement and adding valuable
                      ideas time to time, he always get things done on time.
                      <i className="fa fa-quote-right" />
                    </p>
                    <ul className="stars list-unstyled">
                      <li>
                ...
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      ...
                      supported and exceeded our expectations in every way. Not
                      only was our experience friendly, his ability to identify
                      and present our key messages in an imaginative and
                      creative way gave us a huge amount of confidence in him
                      <i className="fa fa-quote-right" />
                    </p>
                    <ul className="stars list-unstyled">
                      <li>
